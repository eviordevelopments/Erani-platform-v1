                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <button 
                      ...
                      className="bg-gradient-to-r from-erani-purple to-erani-blue flex-1 py-5 rounded-2xl text-xs uppercase tracking-[0.2em] text-white flex items-center justify-center gap-3 shadow-xl shadow-purple-500/20"
                    >
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-10 md:p-20 flex flex-col gap-12 overflow-y-auto max-h-screen no-scrollbar relative z-10">
                ...
                <div className="flex flex-col gap-10">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                                <button className="button-premium px-6 py-3 rounded-xl text-[10px] uppercase tracking-widest">
                                    Subir Logotipo
                                </button>
                ...
                <button 
                  ...
                  className="button-premium w-full py-6 rounded-2xl text-[11px] uppercase tracking-[0.25em] flex items-center justify-center gap-4 mt-4"
                >
            ...
            >
                <div className="w-full max-w-2xl flex flex-col gap-12">
                    ...
                    <div className="flex gap-4">
                        ...
                        >
                            Finalizar Blindaje Forense <CheckCircle2 className="w-6 h-6" />
                        </button>
                    </div>
                </div>
            </motion.div>
